export default function TermsOfUse() {
  return (
    <div className="max-w-4xl mx-auto p-6 sm:p-10 md:p-16 bg-white text-gray-900 min-h-screen">
      <h1 className="text-3xl sm:text-4xl font-bold mb-8 text-center">Terms of Use</h1>
      ...
      <div className="mt-10">
        ...
        <p>
          Frontier Vista Global Inc. is a company incorporated under the laws of Alberta, and Canada. Our primary business location is 15652 18th Avenue SW, Edmonton, Alberta, Canada.
         To get in touch with us, please email <a href="mailto:legal@frontieravista.com" className="text-blue-600 underline">legal@frontieravista.com</a> or call us at <a href="tel:+18258898445" className="text-blue-600 underline">+1.825.889.8445</a>.
        </p>
      </div>
  ...
  <p className="mb-4">
    You are strictly prohibited from using our Website to commit any violation of federal, provincial, local, or international laws, regulations, or other governmental requirements. We reserve the right to report any potentially unlawful activity to relevant law enforcement, regulators, or other third parties without prior notice to you. We will cooperate with such authorities by disclosing your identity where legally required or permitted. In the event of such a violation, your right to use our Website will cease immediately.
  </p>
  <p className="mb-4">
    You are forbidden from violating, or attempting to violate, the security of our Website. You may use the Website only for lawful purposes and in accordance with these Terms. You must not use the Website for:
  </p>
  <ul className="list-disc list-inside space-y-3">
    <li>Violating any applicable federal, provincial, local, or international law or regulation.</li>
    <li>Logging into a server or account without authorization.</li>
    <li>Accessing data or attempting to obtain services not intended for you or your use.</li>
    <li>Attempting to probe, scan, or test the vulnerability of any system, subsystem, or network related to the Website or our computer systems.</li>
...
<div className="mt-10 space-y-8">
  <div>
    <h2 className="text-2xl font-semibold mb-4">Functionality Disclaimer</h2>
